...
function generatePageHTML(loc) {
    ...
    <div style="background: #ffffff; border: 2px solid #134074; padding: 25px 20px; border-radius: 12px; margin-bottom: 35px; box-shadow: 0 8px 20px rgba(0,0,0,0.06);">
        <h3 style="color: #0b2545; margin-top: 0; font-size: 22px; font-weight: 700;">Request an Internal Audit Consultation in ${loc.city_name}</h3>
        <p style="color: #64748b; font-size: 14px; margin-bottom: 20px;">Send your details and our senior risk advisors will review your internal controls, process walkthroughs, or compliance requirements. No obligation.</p>
        ...
        <form action="https://nufca.com/contact-us/" method="POST">
            <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(240px, 1fr)); gap: 15px;">
                ...
                <div style="grid-column: 1 / -1; display: flex; flex-direction: column;">
                    <label style="font-size: 13px; font-weight: 700; color: #0b2545; margin-bottom: 6px;">Internal Audit Services Needed</label>
                    <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(180px, 1fr)); gap: 10px; font-size: 14px;">
                        <label style="display: flex; align-items: center; gap: 8px;"><input type="checkbox" name="services[]" value="Risk-Based Internal Audit"> Risk-Based Internal Audit</label>
                        <label style="display: flex; align-items: center; gap: 8px;"><input type="checkbox" name="services[]" value="Internal Control Review"> Internal Control Review</label>
                        <label style="display: flex; align-items: center; gap: 8px;"><input type="checkbox" name="services[]" value="Business Process & Systems Review"> Business Process & Systems Review</label>
                        <label style="display: flex; align-items: center; gap: 8px;"><input type="checkbox" name="services[]" value="Financial Internal Audit"> Financial Internal Audit</label>
                        <label style="display: flex; align-items: center; gap: 8px;"><input type="checkbox" name="services[]" value="Fraud Risk & Control Review"> Fraud Risk & Control Review</label>
                        <label style="display: flex; align-items: center; gap: 8px;"><input type="checkbox" name="services[]" value="Internal Audit Outsourcing/Co-sourcing"> Internal Audit Outsourcing/Co-sourcing</label>
                    </div>
                </div>

                <div style="grid-column: 1 / -1;">
                    <button type="submit" style="background: #134074; color: #ffffff; font-weight: 700; font-size: 16px; padding: 14px 28px; border: none; border-radius: 8px; cursor: pointer; width: 100%;">Request Internal Audit Proposal</button>
    ...
    <div style="background: #0b2545; color: #fff; text-align: center; padding: 35px 20px; border-radius: 10px; margin-top: 40px;">
        ...
        <a href="https://nufca.com/contact-us/" style="background: #ffffff; color: #0b2545; font-weight: bold; padding: 14px 32px; text-decoration: none; border-radius: 6px; display: inline-block;">Request an Internal Audit Proposal →</a>
    </div>
...
async function createAllProgrammaticPages() {
    console.log("🚀 Creating 5 Programmatic Internal Audit Location Pages in WordPress...\n");
    ...
    console.log("\n🎉 ALL 5 PROGRAMMATIC INTERNAL AUDIT PAGES CREATED & PUBLISHED SUCCESSFULLY!");
}
