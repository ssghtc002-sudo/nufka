...
const pageIds = [99212, 99213, 99214, 99215, 99216];

async function hideTitleMeta() {
    console.log("🚀 Hiding Theme Page Title Meta for 5 Mollak Audit pages...\n");
    ...
    console.log("\n🎉 ALL 5 MOLLAK AUDIT PAGES UPDATED WITH HIDDEN THEME TITLE BANNER!");
}
