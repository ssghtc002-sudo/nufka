...
const pageIds = [99200, 99201, 99202, 99203, 99204];

async function hideTitleMeta() {
    console.log("🚀 Hiding Theme Page Title Meta for 5 RERA Audit pages...\n");
    ...
    console.log("\n🎉 ALL 5 RERA AUDIT PAGES UPDATED WITH HIDDEN THEME TITLE BANNER!");
}
