...
function buildWXRXML() {
    let itemsXML = `
        ...
        <item>
            ...
            <content:encoded><![CDATA[${generateVerbatimDocHTML(mainCorporateTaxPage)}]]></content:encoded>
    ...
    childLocations.forEach((loc) => {
        const htmlContent = generateVerbatimDocHTML(loc);
...
<channel>
    ...
    <description>WordPress 1-Click Importer XML File Direct Root Hierarchy corporate-tax-in-uae</description>
    ...
    console.log(`✅ Direct Root XML created at: ${targetPath2}`);
}
