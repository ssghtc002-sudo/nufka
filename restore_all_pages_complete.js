...
function generateCompletePageHTML(loc) {
...
.nufca-filter-bar { background: #ffffff; border: 2px solid #134074; padding: 12px 18px; border-radius: 10px; margin: 15px 0 25px 0; display: flex; flex-wrap: wrap; align-items: center; justify-content: space-between; gap: 12px; box-shadow: 0 4px 12px rgba(11,37,69,0.06); font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; }
...
.nufca-trust-strip { display: flex; flex-wrap: wrap; gap: 12px; padding-top: 15px; border-top: 1px solid rgba(255,255,255,0.2); font-size: 13px; font-weight: 600; margin-top: 15px; }
...
async function restoreAllPagesComplete() {
    console.log("🚀 Restoring 100% complete HTML structure (Hero + Lead Form + Filter Dropdown + Content) to all 5 pages...");

    for (const loc of locations) {
        const fullHTML = generateCompletePageHTML(loc);
    ...
    console.log("🎉 ALL 5 PAGES RESTORED WITH 100% COMPLETE HERO, LEAD FORM, FILTER DROPDOWN & CONTENT!");
}

restoreAllPagesComplete();
