...
async function updateMegamenuFta() {
    console.log("🚀 Updating Elementor Megamenu (Post ID 5137) with /fta-vat-audit-assistance-uae/ link...");
    ...
    const replaceUrls = (str) => {
        return str
            ...
            .replace(/https:\/\/nufca\.com\/services\/mollak-services/g, 'https://nufca.com/mollak-audit-services-uae/')
            .replace(/https:\/\/nufca\.com\/services\/fta-vat-audit-assistance/g, 'https://nufca.com/fta-vat-audit-assistance-uae/')
            .replace(/\/services\/fta-vat-audit-assistance/g, '/fta-vat-audit-assistance-uae/')
            .replace(/\/fta-vat-audit-assistance/g, '/fta-vat-audit-assistance-uae/');
    };
