...
const vatLocations = [
    {
        ...
        eyebrow: "FTA-Registered Tax Agent #20048123 • Federal Decree-Law No. 8 of 2017",
        hero_headline: "VAT Consultancy Services in UAE Reviewed by Chartered Accountants",
        hero_subheadline: "Registration, quarterly returns, VAT211 voluntary disclosures, input VAT recovery and FTA audit defense — structured by qualified chartered accountants."
    },
    {
        id: 99147,
        slug: "dubai",
        ...
        eyebrow: "FTA-Registered Tax Agent #20048123 • Dubai Mainland & Free Zones",
        hero_headline: "VAT Consultancy Services in Dubai Reviewed by Chartered Accountants",
        hero_subheadline: "Registration, quarterly returns, VAT211 voluntary disclosures, input VAT recovery and FTA audit defense for Dubai businesses."
    },
    {
        id: 99148,
    ...
    },
    {
        ...
        eyebrow: "FTA-Registered Tax Agent #20048123 • Abu Dhabi Tamouh Tower Branch",
        hero_headline: "VAT Consultancy Services in Abu Dhabi Reviewed by Chartered Accountants",
        hero_subheadline: "Registration, quarterly returns, VAT211 voluntary disclosures, input VAT recovery and FTA audit defense for Abu Dhabi entities."
    },
    {
        id: 99150,
        slug: "sharjah",
        ...
        eyebrow: "FTA-Registered Tax Agent #20048123 • Hamriyah Free Zone Branch",
        hero_headline: "VAT Consultancy Services in Sharjah Reviewed by Chartered Accountants",
        hero_subheadline: "Registration, quarterly returns, VAT211 voluntary disclosures, input VAT recovery and FTA audit defense for Sharjah & HFZ companies."
    }
];

function generateUpgradedVatHTML(loc) {
    const currentSlug = loc.slug;
    
    return `<div class="nufca-article-container" style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; line-height: 1.75; color: #1d2d44; max-width: 1050px; margin: 0 auto; padding: 10px;">
    
    <!-- Filter Location Dropdown Bar -->
    <div class="nufca-filter-bar" style="background: #ffffff; border: 2px solid #134074; padding: 12px 18px; border-radius: 10px; margin: 10px 0 20px 0; display: flex; flex-wrap: wrap; align-items: center; justify-content: space-between; gap: 12px; box-shadow: 0 4px 12px rgba(11,37,69,0.06);">
    ...
    <!-- Upgraded Ultra-Premium Hero Section -->
    <div style="background: linear-gradient(135deg, #0b2545 0%, #134074 55%, #1d2d44 100%); color: #ffffff; padding: 45px 30px; border-radius: 16px; margin-bottom: 30px; box-shadow: 0 12px 30px rgba(11,37,69,0.18); border: 1px solid rgba(255,255,255,0.15); position: relative; overflow: hidden;">
        
        <div style="display: flex; flex-wrap: wrap; gap: 10px; margin-bottom: 15px;">
            <span style="background: rgba(255,255,255,0.18); color: #ffffff; font-size: 12px; font-weight: 800; padding: 6px 14px; border-radius: 20px; text-transform: uppercase; letter-spacing: 0.5px; border: 1px solid rgba(255,255,255,0.25);">
                🛡️ ${loc.eyebrow}
            </span>
            <span style="background: #eab308; color: #0b2545; font-size: 12px; font-weight: 800; padding: 6px 14px; border-radius: 20px; text-transform: uppercase; letter-spacing: 0.5px;">
                ⭐ Cabinet Decision No. 129 of 2025 Ready
            </span>
        </div>

        <h1 style="color: #ffffff !important; font-size: clamp(26px, 5.5vw, 38px); margin-top: 10px; font-weight: 800; line-height: 1.22; text-shadow: 0 2px 4px rgba(0,0,0,0.3);">${loc.hero_headline}</h1>
        <p style="font-size: 18px; opacity: 0.95; max-width: 900px; margin-bottom: 25px; line-height: 1.6;">${loc.hero_subheadline}</p>

        <!-- Metrics Grid -->
        <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(180px, 1fr)); gap: 12px; margin: 25px 0 20px 0; background: rgba(255, 255, 255, 0.08); padding: 18px; border-radius: 12px; border: 1px solid rgba(255, 255, 255, 0.15);">
            <div>
                <div style="font-size: 22px; font-weight: 800; color: #fbbf24;">24 Hours</div>
                <div style="font-size: 12px; opacity: 0.9; font-weight: 600;">Response Guarantee</div>
            </div>
            <div>
                <div style="font-size: 22px; font-weight: 800; color: #fbbf24;">100%</div>
                <div style="font-size: 12px; opacity: 0.9; font-weight: 600;">FTA Ledger Reconciled</div>
            </div>
            <div>
                <div style="font-size: 22px; font-weight: 800; color: #fbbf24;">500+</div>
                <div style="font-size: 12px; opacity: 0.9; font-weight: 600;">UAE Clients Supported</div>
            </div>
            <div>
                <div style="font-size: 22px; font-weight: 800; color: #fbbf24;">04 325 8361</div>
                <div style="font-size: 12px; opacity: 0.9; font-weight: 600;">Direct CA Hotline</div>
            </div>
        </div>
        ...
        <div style="display: flex; flex-wrap: wrap; gap: 15px; padding-top: 15px; border-top: 1px solid rgba(255,255,255,0.2); font-size: 13px; font-weight: 600;">
            ...
            <span>✓ Zero Penalty Exposure Focus</span>
        </div>

        <!-- Branch Address Bar -->
        <div style="background: rgba(255, 255, 255, 0.12); border: 1px solid rgba(255, 255, 255, 0.25); padding: 16px 22px; border-radius: 10px; margin-top: 20px; font-size: 14px;">
            <div style="font-weight: bold; color: #93c5fd; font-size: 11px; text-transform: uppercase; letter-spacing: 0.5px;">📍 ${loc.branch_title}:</div>
            <div style="font-size: 15px; font-weight: bold; margin-top: 3px;">${loc.address}</div>
...
async function updateVatPageMetaAndHero() {
    console.log("🚀 Updating Theme Page Title Meta & Upgraded Hero Section across all 5 VAT pages...\n");

    for (const loc of vatLocations) {
        console.log(`Updating Page ID ${loc.id} (${loc.slug})...`);

        const newHTML = generateUpgradedVatHTML(loc);

        // 1. Update Content via REST API
        ...
        console.log(`  --> REST Content Update Status: ${res.status}`);

        // 2. Hide Theme Page Title Banner via WP Admin post.php
        const editRes = await fetch(`https://nufca.com/wp-admin/post.php?post=${loc.id}&action=edit`, {
            headers: {
                "Cookie": cookies,
        ...
        formData.append('post_ID', loc.id.toString());
        ...
        console.log(`  --> Title Banner Hide Status for ID ${loc.id}: ${postMetaRes.status}`);
    }

    console.log("\n🎉 ALL 5 VAT PAGES UPDATED WITH UPGRADED HERO SECTION & HIDDEN THEME TITLE BANNER!");
}

updateVatPageMetaAndHero();
