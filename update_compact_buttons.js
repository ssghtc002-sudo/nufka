...
function generatePageHTML(loc) {
    ...
    <div class="nufca-consultation-card">
        <div class="nufca-card-content">
            <span style="display: inline-block; background: #e0f2fe; color: #0369a1; font-weight: 800; font-size: 11px; padding: 4px 10px; border-radius: 20px; text-transform: uppercase; letter-spacing: 0.5px; margin-bottom: 6px;">Direct Advisory Access</span>
            <h3 style="color: #0b2545; margin: 4px 0 8px 0; font-size: clamp(18px, 3.2vw, 21px); font-weight: 800; line-height: 1.3;">Speak With Our Senior Internal Audit Experts in ${loc.city_name}</h3>
...
async function updateAllPages() {
    console.log("🚀 Updating all 5 Internal Audit pages with perfectly proportioned compact button layout...\n");
    ...
    console.log("\n🎉 ALL 5 INTERNAL AUDIT PAGES OPTIMIZED WITH BALANCED BUTTONS!");
}
