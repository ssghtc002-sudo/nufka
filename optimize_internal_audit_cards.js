...
function generatePageHTML(loc) {
    ...
    .nufca-btn-call {
        ...
        color: #ffffff !important;
        box-shadow: 0 3px 10px rgba(19, 64, 116, 0.2);
    }
    ...
    <!-- Optimized Mobile & Desktop Direct Consultation Card -->
    <div class="nufca-consultation-card">
        <div class="nufca-card-content">
            <span style="display: inline-block; background: #e0f2fe; color: #0369a1; font-weight: 800; font-size: 11px; padding: 4px 10px; border-radius: 20px; text-transform: uppercase; letter-spacing: 0.5px; margin-bottom: 8px;">Direct Advisory Access</span>
            <h3 style="color: #0b2545; margin: 6px 0 10px 0; font-size: clamp(19px, 3.5vw, 22px); font-weight: 800; line-height: 1.3;">Speak With Our Senior Internal Audit Experts in ${loc.city_name}</h3>
            <p style="color: #475569; font-size: 14px; margin: 0; line-height: 1.6;">Get immediate feedback on your internal controls, process walkthroughs, or compliance requirements. Connect directly with our chartered accountants without filling forms.</p>
        </div>
...
async function updateAllPages() {
    console.log("🚀 Updating 5 Internal Audit Pages with Fully Responsive Desktop & Mobile Card...\n");
    ...
    console.log("\n🎉 ALL 5 INTERNAL AUDIT PAGES OPTIMIZED FOR MOBILE & DESKTOP!");
}
