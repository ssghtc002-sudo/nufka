...
const pageIds = [99222, 99223, 99224, 99225, 99226];

async function hideTitleMeta() {
    console.log("🚀 Hiding Theme Page Title Meta for 5 FTA VAT Audit pages...\n");
    ...
    console.log("\n🎉 ALL 5 FTA VAT AUDIT PAGES UPDATED WITH HIDDEN THEME TITLE BANNER!");
}
