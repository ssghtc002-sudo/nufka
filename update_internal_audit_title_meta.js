...
const pageIds = [99172, 99173, 99174, 99175, 99176];

async function hideTitleMeta() {
    console.log("🚀 Hiding Theme Page Title Meta for 5 Internal Audit pages...\n");
    ...
    console.log("\n🎉 ALL 5 INTERNAL AUDIT PAGES UPDATED WITH HIDDEN THEME TITLE BANNER!");
}
